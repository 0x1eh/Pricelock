...
***Note**: _All files, except html mock-ups, has .md format that is convinient to view directly in this github repo via web-browser. html-file is better (if you don't have github html viwer extention) to download and open with your web-browser._
