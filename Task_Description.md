...
-  Now we want to add a second service that will be available at the same time. The working name of this service is Pricelock.
Advanced Reservation is the default service when tickets are not yet available for sale. It is similar to a regular ticket purchase, but the difference is that the tickets are not issued immediately — they will be
...
1. The proposed User Flow
2. Operational Flow (Back Office)
3. High-level Wireframes / Mockups
4. A description of the feature (customer-facing / operational-facing)
5. Acceptance Criteria in free form
While preparing the final solution, you may use any tools, including any AI products (recommended).
When using AI, please attach screenshots/copies of your prompts.